...
public class TerrapizzaPage {
    ...
    public static final String MARGARITA_IN_CARD = "//div [@class=\"basket__products-item-name\"]";

    public static final String PAGE_BAR = "//li[16]/a [@href=\"/catalog/bar\"]";
    public static final String COLA_IN_BAR = "//div/button [@data-id=\"1736\"]";
    public static final String COLA_IN_CARD = "//li[2]/div[2]/div/div [@class=\"basket__products-item-name\"]";
}
